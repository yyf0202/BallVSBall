...
namespace HighFive
{
    /// This script provides a raycaster for use with the VRPointerInputModule.
    /// It behaves similarly to the standards Graphic raycaster, except that it utilize raycast
    /// modes specifically for VR.
    ///
    /// View VRBasePointerRaycaster.cs and VRPointerInputModule.cs for more details.
    [RequireComponent(typeof(Canvas))]
    public class VRPointerGraphicRaycaster : VRBasePointerRaycaster
    {
                ...
                switch (raycastMode)
                {
                    case RaycastMode.Direct:
                        if (cachedPointerEventCamera == null)
                        {
                            ...
                            if (cachedPointerEventCamera == null)
                            {
                                Debug.LogError("VRPointerGraphicRaycaster requires VRPointer to have a Camera when in Direct mode.");
                            }
                        }
        ...
        protected VRPointerGraphicRaycaster()
        {
        }
        ...
        public override void Raycast(PointerEventData eventData, List<RaycastResult> resultAppendList)
        {
            ...
            {
                Debug.LogError("VRPointerGraphicRaycaster requires that the canvase renderMode is set to WorldSpace.");
                return;
            }
